  ...
  return (
    <div className="relative block">
      <div className="relative min-h-[420px] lg:min-h-[520px] overflow-hidden bg-black">
        {slide.imageUrl && <Image key={slide.imageUrl} src={slide.imageUrl} alt={product.title} fill priority={active === 0} className="object-cover opacity-85 transition-opacity duration-700" sizes="(max-width: 1024px) 100vw, 50vw" />}
