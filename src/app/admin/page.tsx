...
export default function AdminPage() {
  ...
  const deleteProduct = async (handle: string) => {
    try {
      ...
      await load(); setDeleteConfirm(null); flash('Product and its images deleted.')
